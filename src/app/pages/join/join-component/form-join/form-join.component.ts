...
sendForm(newHero: InterfaceJoin){
  ...
  constructor(private formbuilder: FormBuilder) { 
    ...
    this.form = this.formbuilder.group({
      ...
      intelligence: ['', [, Validators.maxLength(3)]],
      strength: ['', [, Validators.maxLength(3)]],
      speed: ['', [, Validators.maxLength(3)]],
      durability: ['', [, Validators.maxLength(3)]],
      power: ['', [, Validators.maxLength(3)]],
      combat: ['', [, Validators.maxLength(3)]],
